      ...
      function(cultureSrv) {
        return {
          ...
          link: function(scope) {
            ...
            scope.$on('eventSrv::ready', function() {
              scope.currentLang = cultureSrv.getCultureCode();
            });
          }
        }
      ...
      function(cultureSrv) {
        return {
          ...
          link: function(scope, element) {
            console.log('culture loadded');
            scope.$on('eventSrv::ready', function() {
              element
                .removeClass('leftToRight')
                .removeClass('rightToLeft')
                .addClass(cultureSrv.getTextDirection());

              var customFont = cultureSrv.getCustomFont();
              if (customFont) {
                element.addClass(customFont);
              }
            });
          }
        }
